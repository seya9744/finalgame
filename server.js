...
const mainKeyboard = (isReg) => {
    ...
    r.push([Markup.button.callback("Check Balance 💵", "bal"), Markup.button.callback("Deposit 💰", "dep")], [Markup.button.callback("Contact Support...", "support_trigger"), Markup.button.callback("Instruction 📖", "rules_trigger")], [Markup.button.callback("Withdraw 🤑", "w_start")]);
...
bot.action('instructions_trigger', (ctx) => {
    const html = `<b>📘 የቢንጎ ህጎች</b>\n\n<blockquote><b>🃏 መጫወቻ ካርድ</b>\n\n1. ከ1-300 ካርድ አንዱን ይምረጡ።\n2. ቀይ ማለት ሌላ ተጫዋች መርጦታል።</blockquote>\n\n<blockquote><b>🎮 ጨዋታ</b>\n1. ቁጥሮች ከ1-75 ይጠራሉ::\n2. ካርዶ ላይ ካለ ይንኩት::</blockquote>`;
...
bot.on('text', async (ctx) => {
    ...
    if (ctx.session?.state === 'WAIT_W_AMT') {
        ...
        ctx.session.w_amt = a; ctx.session.state = 'WAIT_W_ID';
